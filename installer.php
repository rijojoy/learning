...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190711_deskera_c5e40bbe3c8c11ee5610_20190711190508_archive.zip';
	const ARCHIVE_SIZE		 = '93290443';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c5e40bb-11190508';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.16==');
		self::log('----------------------------------------------------');
